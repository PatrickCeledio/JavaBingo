...
public class Bingo {
    ...
    static void printBingoCard(String[] bingoCard){
        ...
        System.out.println("| \t" + bingoCard[0] + "\t | \t" + bingoCard[1]  + "\t | \t"
                + bingoCard[2] + " | \t" + bingoCard[3]  + " | \t" +  bingoCard[4] + " |\t");
        System.out.println("| \t" + bingoCard[5] + "\t | \t" + bingoCard[6]  + "\t | \t"
                + bingoCard[7] + " | \t" + bingoCard[8]  + " | \t" +  bingoCard[9] + " |\t");
        System.out.println("| \t" + bingoCard[10] + "\t | \t" + bingoCard[11]  + "\t | \t"
                + bingoCard[12] + " | \t" + bingoCard[13]  + " | \t" +  bingoCard[14] + " |\t");
        System.out.println("| \t" + bingoCard[15] + "\t | \t" + bingoCard[16]  + "\t | \t"
                + bingoCard[17] + " | \t" + bingoCard[18]  + " | \t" +  bingoCard[19] + "\t |\t");
    }
    ...
    static void play(){
        ...
        // Generate and save bingo card and chance
